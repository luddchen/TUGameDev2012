...
namespace RoBuddies.Model.Worlds.Tutorial
{
    ...
    /// </summary>
    class Tutorial_5 : MountainLevel.MountainLevel
    {
        ...
        protected override void addLevelLabels()
        {
            ...
            {
                HUDTexture textureSwitcher = new HUDTexture(game.Content.Load<Texture2D>("Sprites//Keyboard//A"), null, 128, 128, null, 0.8f, null, game.Content);
