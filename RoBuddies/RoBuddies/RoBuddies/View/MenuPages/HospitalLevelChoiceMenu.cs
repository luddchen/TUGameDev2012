...
{
    class HospitalLevelChoiceMenu : LevelMainMenu
    {
        ...
        public HospitalLevelChoiceMenu(LevelMenu menu, ContentManager content)
            : base(menu, content)
        {
            levelChoose = new HUDString("choose a Hospital level :", null, null, Color.SkyBlue, null, 0.7f, null, content);
